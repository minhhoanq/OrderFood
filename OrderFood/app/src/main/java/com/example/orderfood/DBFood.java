...
public class DBFood {
    ...
    public DBFood(Context appContext) {
    ...
    public ArrayList<Popular> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Popular> playerList =  new ArrayList<Popular>();

        for(String jObjString : objStrings){
            Popular player  = gson.fromJson(jObjString,  Popular.class);
    ...
    public void putListObject(String key, ArrayList<Popular> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Popular player: playerList){
